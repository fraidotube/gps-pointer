...
final class _AuthBrand extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Column(
    children: [
      Image.asset('asset/fry_app.png', width: 88, height: 88),
      const SizedBox(height: 14),
      Text('GPS Pointer', style: Theme.of(context).textTheme.headlineMedium),
      const SizedBox(height: 4),
      const Text(
        'App puntamento GPS',
        style: TextStyle(color: Color(0xFF9FB6C2)),
      ),
    ],
  );
}
